...
void CanMessaging_Test(void){
	...
	while(1){
		...
		CanMessaging_SetValue(Can_PEDALS_AcceleratorSensor1TravelPercentage, cnt);
		CanMessaging_SetValue(Can_PEDALS_AcceleratorSensor2TravelPercentage, cnt);
		CanMessaging_SetValue(Can_PEDALS_BrakeSensor1Voltage, cnt);
		CanMessaging_SetValue(Can_PEDALS_BrakeSensor2Voltage, cnt);
		CanMessaging_SetValue(Can_PEDALS_BrakeSensor1TravelPercentage, cnt);
		CanMessaging_SetValue(Can_PEDALS_BrakeSensor2TravelPercentage, cnt);
		CanMessaging_SetValue(Can_PEDALS_PressureSensorVoltage, cnt);
		...
		CanMessaging_SetValue(Can_INVERTERS_LeftInverterInputVoltage, cnt);
		CanMessaging_SetValue(Can_INVERTERS_LeftInverterCurrent, cnt);
		CanMessaging_SetValue(Can_INVERTERS_LeftMotorRpm, cnt);
		CanMessaging_SetValue(Can_INVERTERS_LeftMotorSpeedKmh, cnt);
		CanMessaging_SetValue(Can_INVERTERS_LeftInverterThrottle, cnt);
		CanMessaging_SetValue(Can_INVERTERS_LeftInverterThrottleFeedback, cnt);
		...
		CanMessaging_SetValue(Can_INVERTERS_RightInverterInputVoltage, cnt);
		CanMessaging_SetValue(Can_INVERTERS_RightInverterCurrent, cnt);
		CanMessaging_SetValue(Can_INVERTERS_RightMotorRpm, cnt);
		CanMessaging_SetValue(Can_INVERTERS_RightMotorSpeedKmh, cnt);
		CanMessaging_SetValue(Can_INVERTERS_RightInverterSentThrottle, cnt);
		CanMessaging_SetValue(Can_INVERTERS_RightInverterThrottleFeedback, cnt);
